...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Toast.makeText(this,"activty created", Toast.LENGTH_SHORT).show();
    ...
    {
        super.onStop();
        Toast.makeText(this,"activity stoping", Toast.LENGTH_SHORT).show();
    }
    @Override
    protected void onDestroy()
    {
        super.onDestroy();
        Toast.makeText(this,"activity destroying", Toast.LENGTH_SHORT).show();
    }
    @Override
